...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour,IDamageable
    {
        ...
        public ParticleSystem _stepParticle;
        public ParticleSystem _landParticle;
        ...
        [SerializeField]private ParticleSystem _danceParticle;
        ...
        private void Start()
        {
            ...
            FootstepAudioVolume = SoundManager.Instance.GetSFXVolume();
            _hasAnimator = TryGetComponent(out _animator);
            _controller = GetComponent<CharacterController>();
            wandState = GetComponent<WandState>();
        ...
        private void Move()
        {
                ...
                currentHorizontalSpeed > targetSpeed + speedOffset)
            {
                ...
                _speed = Mathf.Lerp(currentHorizontalSpeed, targetSpeed * inputMagnitude * _sensitivity,
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                // Jump
                if (_input.jump && _jumpTimeoutDelta <= 0.0f && !dialogueUI.IsOpen)
                {
                    _stepParticle.Stop();
